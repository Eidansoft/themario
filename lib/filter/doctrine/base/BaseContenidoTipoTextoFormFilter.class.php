...
/**
 * ContenidoTipoTexto filter form base class.
 *
 * @package    themario
 * @subpackage filter
 ...
 */
abstract class BaseContenidoTipoTextoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('contenido_tipo_texto_filters[%s]');
