...
/**
 * RespuestasTipoPreguntaAlternativa filter form base class.
 *
 * @package    themario
 * @subpackage filter
 ...
 */
abstract class BaseRespuestasTipoPreguntaAlternativaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('respuestas_tipo_pregunta_alternativa_filters[%s]');
