...
/**
 * TipoRespuestaAlternativa form base class.
 *
 * @method TipoRespuestaAlternativa getObject() Returns the current form's model object
 *
 * @package    themario
 * @subpackage form
 ...
 */
abstract class BaseTipoRespuestaAlternativaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tipo_respuesta_alternativa[%s]');
