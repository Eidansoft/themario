...
/**
 * TipoPreguntaCorta form base class.
 *
 * @method TipoPreguntaCorta getObject() Returns the current form's model object
 *
 * @package    themario
 * @subpackage form
 ...
 */
abstract class BaseTipoPreguntaCortaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tipo_pregunta_corta[%s]');
