...
/**
 * ContenidoTipoCuestionario form base class.
 *
 * @method ContenidoTipoCuestionario getObject() Returns the current form's model object
 *
 * @package    themario
 * @subpackage form
 ...
 */
abstract class BaseContenidoTipoCuestionarioForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('contenido_tipo_cuestionario[%s]');
