...
/**
 * Texto form base class.
 *
 * @method Texto getObject() Returns the current form's model object
 *
 * @package    themario
 * @subpackage form
 ...
 */
abstract class BaseTextoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('texto[%s]');
