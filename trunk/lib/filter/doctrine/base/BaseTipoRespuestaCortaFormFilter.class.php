...
/**
 * TipoRespuestaCorta filter form base class.
 *
 * @package    themario
 * @subpackage filter
 ...
 */
abstract class BaseTipoRespuestaCortaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tipo_respuesta_corta_filters[%s]');
