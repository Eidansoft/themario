 ...
 * @method RespuestaAlternativa setCuestionId()  Sets the current record's "cuestion_id" value
 * @method RespuestaAlternativa setTexto()       Sets the current record's "texto" value
 * @method RespuestaAlternativa setCuestion()    Sets the current record's "Cuestion" value
 * 
 * @package    themario
 * @subpackage model
