...
Doctrine_Manager::getInstance()->bindComponent('TipoPreguntaAlternativa', 'doctrine');

/**
 * BaseTipoPreguntaAlternativa
 * 
 ...
 */
abstract class BaseTipoPreguntaAlternativa extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('tipoPreguntaAlternativa');
