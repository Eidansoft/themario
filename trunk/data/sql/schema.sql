...
CREATE TABLE cuestionario (id INT AUTO_INCREMENT, contenido_id INT NOT NULL, INDEX contenido_id_idx (contenido_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE texto (id INT AUTO_INCREMENT, texto TEXT, contenido_id INT NOT NULL, INDEX contenido_id_idx (contenido_id), PRIMARY KEY(id)) ENGINE = INNODB;
ALTER TABLE contenido ADD CONSTRAINT contenido_tema_id_tema_id FOREIGN KEY (tema_id) REFERENCES tema(id);
ALTER TABLE cuestion ADD CONSTRAINT cuestion_cuestionario_id_cuestionario_id FOREIGN KEY (cuestionario_id) REFERENCES cuestionario(id);
ALTER TABLE cuestionario ADD CONSTRAINT cuestionario_contenido_id_contenido_id FOREIGN KEY (contenido_id) REFERENCES contenido(id);
...
ALTER TABLE texto ADD CONSTRAINT texto_contenido_id_contenido_id FOREIGN KEY (contenido_id) REFERENCES contenido(id);
